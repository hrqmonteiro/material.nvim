...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Operator', { fg = c.materialBlue, bg = 'NONE' })
    ...
    hl(0, 'TSPunctBracket', { fg = c.materialBlue, bg = 'NONE' })
    ...
    hl(0, 'TSKeywordReturn', { fg = c.materialBlue, bg = 'NONE' })
    hl(0, 'TSOperator', { fg = c.materialBlue, bg = 'NONE' })
    ...
    hl(0, 'TSInclude', { fg = c.materialBlue, bg = 'NONE' })
    hl(0, 'TSVariable', { fg = c.materialWhite, bg = 'NONE' })
    hl(0, 'TSVariableBuiltin', { fg = c.materialWhite, bg = 'NONE' })
    ...
    hl(0, 'tstagdelimiter', { fg = c.materialblue, bg = 'none' })
