...
theme.set_highlights = function(opts)
    ...
    hl(0, 'CursorLineNr', { fg = c.materialPopupFront, bg = c.materialBack })
    ...
    hl(0, 'Visual', { fg = c.materialNone, bg = c.materialSelection })
    ...
    hl(0, 'Conditional', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'Repeat', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'Label', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'Operator', { fg = c.materialFront, bg = 'NONE' })
    hl(0, 'Keyword', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'Exception', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'PreProc', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'Include', { fg = c.materialPink, bg = 'NONE' })
    ...
    hl(0, 'Tag', { fg = c.materialFront, bg = 'NONE' })
    ...
    hl(0, 'TSPunctBracket', { fg = c.materialFront, bg = 'NONE' })
    ...
    hl(0, 'TSParameter', { fg = c.materialLightBlue, bg = 'NONE' })
    ...
    hl(0, 'TSProperty', { fg = c.materialLightBlue, bg = 'NONE' })
    hl(0, 'TSConstructor', { fg = c.materialBlueGreen, bg = 'NONE' })
    hl(0, 'TSConditional', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'TSRepeat', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'TSLabel', { fg = c.materialLightBlue, bg = 'NONE' })
    hl(0, 'TSKeyword', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'TSKeywordFunction', { fg = c.materialBlue, bg = 'NONE' })
    hl(0, 'TSKeywordOperator', { fg = c.materialBlue, bg = 'NONE' })
    hl(0, 'TSOperator', { fg = c.materialFront, bg = 'NONE' })
    hl(0, 'TSException', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'TSType', { fg = c.materialBlueGreen, bg = 'NONE' })
    hl(0, 'TSTypeBuiltin', { fg = c.materialBlue, bg = 'NONE' })
    hl(0, 'TSStructure', { fg = c.materialLightBlue, bg = 'NONE' })
    hl(0, 'TSInclude', { fg = c.materialPink, bg = 'NONE' })
    hl(0, 'TSVariable', { fg = c.materialLightBlue, bg = 'NONE' })
    hl(0, 'TSVariableBuiltin', { fg = c.materialLightBlue, bg = 'NONE' })
    hl(0, 'TSText', { fg = c.materialFront, bg = 'NONE' })
    hl(0, 'TSUnderline', { fg = c.materialYellowOrange, bg = 'NONE' })
    hl(0, 'TSTag', { fg = c.materialBlue, bg = 'NONE' })
    hl(0, 'TSTagDelimiter', { fg = c.materialGray, bg = 'NONE' })
    ...
    hl(0, 'TSStringEscape', { fg = isDark and c.materialOrange or c.materialYellowOrange, bold = true })
